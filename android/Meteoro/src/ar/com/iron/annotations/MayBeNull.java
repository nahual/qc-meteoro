 ...
 * para indicar que un valor puede ser o es soportado null.<br>
 * <br>
 ...
 * el caso.<br>
 * - <b>En un parámetro</b>: Indica que el método acepta null como valor posible.<br>
 * - <b>En una variable local</b>: No tiene mucho sentido pero se deja abierta la posibilidad de
 * uso, para indicar que puede ser null en caso de que sea un código complejo. (No se aconseja
 * usarlo)
 * 
 * @author D. García
 */
